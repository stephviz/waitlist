defmodule WaitlistWeb.Router do
  ...
  if Application.compile_env(:waitlist, :dev_routes) do
  ...
  scope "/", WaitlistWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{WaitlistWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", WaitlistWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{WaitlistWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", WaitlistWeb do
    ...
    live_session :current_user,
      on_mount: [{WaitlistWeb.UserAuth, :mount_current_user}] do
